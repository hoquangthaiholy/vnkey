...
fn test_telex_complex() {
    ...
    engine.reset();
    assert_eq!(type_word(&mut engine, "choiw"), "chơi");
    engine.reset();
    assert_eq!(type_word(&mut engine, "guiwr"), "gửi");
    engine.reset();
...
fn test_telex_recovery_scenarios() {
    ...
    engine.reset();
    assert_eq!(type_word(&mut engine, "reneew"), "renew");
    engine.reset();
    assert_eq!(type_word(&mut engine, "pronoounce"), "pronounce");
    engine.reset();
    assert_eq!(type_word(&mut engine, "kieuer"), "kiểu");
    engine.reset();
    assert_eq!(type_word(&mut engine, "hieues"), "hiếu");
    engine.reset();
    assert_eq!(type_word(&mut engine, "yeues"), "yếu");
    engine.reset();
    assert_eq!(type_word(&mut engine, "trieuej"), "triệu");
    engine.reset();
    assert_eq!(type_word(&mut engine, "nhieuef"), "nhiều");
    engine.reset();
    ...
    engine.reset();
    assert_eq!(type_word(&mut engine, "wwww"), "www");
    engine.reset();
